...
def draw_a_cat(x, y, sizex, sizey, r1, g1, b1, r2, g2, b2, orientation):
    if orientation==1:
        for i in range(6): #tail
            ...
            polygon(screen, (r1, g1, b1), [(x+sizex/4.3-1 , y-0.1*sizey+1), (x+sizex/4.8-1, y+0.2*sizey-1), (x+sizex/6.3+1, y+0.05*sizey), (x+sizex/4.3-1 , y-0.1*sizey+1)]) #rightear
            ...
            polygon(screen, (r1, g1, b1), [(x+1 , y-0.1*sizey+1), (x+sizex/45+1, y+0.2*sizey-1), (x+sizex/13-1, y+0.05*sizey), (x+1 , y-0.1*sizey+1)]) #leftear
            ...
            ellipse(screen, (r2, g2, b2), [x+sizex/28, y+sizey/4, sizex/14.5 , sizey/4.2]) #lefteye
            ...
            ellipse(screen, (r2, g2, b2), [x+sizex/7.2, y+sizey/4, sizex/14.5 , sizey/4.2]) #righteye
        ...
        for i in range(6): #tail
            ellipse(screen, (0,0,0), [x-sizex/2.1-sizex*i/25-1, y+0.22*sizey+sizey*i/40-1, sizex/8.2+2 , sizey/2.7+2])
            ellipse(screen, (r1, g1, b1), [x-sizex/2.1-sizex*i/25, y+0.22*sizey+sizey*i/40, sizex/8.2 , sizey/2.7])
    
            ellipse(screen, (0,0,0), [x-sizex/2.5-1, y-sizey/30-1, sizex/2+2 , 0.9*sizey+2]) #bodyline
            ellipse(screen, (r1, g1, b1), [x-sizex/2.5, y-sizey/30, sizex/2 , 0.93*sizey]) #body
        
            ellipse(screen, (0,0,0), [x+sizex/10-1, y+0.43*sizey-1, sizex/12+2 , sizey/2.4+2]) #backpawline
            ellipse(screen, (r1, g1, b1), [x+sizex/10, y+0.43*sizey, sizex/12 , sizey/2.4]) #backpaw
    
            ellipse(screen, (0,0,0), [x-sizex/37-1, y+0.7*sizey-1, sizex/7+2 , sizey/3.6+2]) #frontpawline
            ellipse(screen, (r1, g1, b1), [x-sizex/37, y+0.7*sizey, sizex/7 , sizey/3.6]) #frontpaw
    
            ellipse(screen, (0,0,0), [x-1, y-1, sizex/4.2+2 , sizey/1.35+2], 1) #headline
            ellipse(screen, (r1, g1, b1), [x, y, sizex/4.2 , sizey/1.35]) #head
    
            ellipse(screen, (0,0,0), [x-sizex/2.35-1, y+0.47*sizey-1, sizex/5.5+2, sizey/1.75+2]) #legbaseline
            ellipse(screen, (r1, g1, b1), [x-sizex/2.35, y+0.47*sizey, sizex/5.5, sizey/1.75]) #legbase
    
            ellipse(screen, (0,0,0), [x-sizex/2.15-1, y+0.8*sizey-1, sizex/15+2 , sizey/2+2]) #legline
            ellipse(screen, (r1, g1, b1), [x-sizex/2.15, y+0.8*sizey, sizex/15 , sizey/2]) #leg
            ...
            ellipse(screen, (0,0,0), [x+sizex/28-1, y-1+sizey/4, sizex/14.5+2 , sizey/4.2+2], 1) #lefteyeline
            ellipse(screen, (r2, g2, b2), [x+sizex/28, y+sizey/4, sizex/14.5 , sizey/4.2]) #lefteye
            ellipse(screen, (0,0,0), [x+sizex/28+sizex/50, y+sizey/3.9, sizex/80 , sizey/4.6]) #lefteyelid
            ellipse(screen, (234,245,234), [x+sizex/28+sizex/35, y+sizey/3.7, sizex/35 , sizey/10]) #lefteyeshine
    
            ellipse(screen, (0,0,0), [x+sizex/7.2-1, y-1+sizey/4, sizex/14.5+2 , sizey/4.2+2], 1) #righteyeline
            ellipse(screen, (r2, g2, b2), [x+sizex/7.2, y+sizey/4, sizex/14.5 , sizey/4.2]) #righteye
            ellipse(screen, (0,0,0), [x+sizex/7.2+sizex/50, y+sizey/3.9, sizex/80 , sizey/4.6]) #righteyelid
            ellipse(screen, (234,245,234), [x+sizex/7.2+sizex/35, y+sizey/3.7, sizex/35 , sizey/10]) #lefteyeshine
...
def ball_of_thread(x, y, r, orientation):
    ...
    if orientation==1:
        ...
        arc(screen, (0,0,0), [x-r+0.17*r, y-r+0.25*r, 1.9*r, 1.9*r], 1.66, 3.14, 1)
        arc(screen, (0,0,0), [x-r+0.35*r, y-r+0.35*r, 2*r, 2*r], 1.66, 3.14, 1)
        arc(screen, (0,0,0), [x-r+0.45*r, y-r+0.45*r, 2*r, 2*r], 1.66, 3.14, 1)
    ...
    if orientation==1:
        ...
        arc(screen, (154,154,154), [x+0.33*r, y+0.225*r, 0.7*r, 0.7*r], 4.1888, 5.236, 1)
    
        arc(screen, (154,154,154), [x+0.33*r+0.35*r, y+0.225*r+0.606*r, 0.7*r, 0.7*r], 1.0472, 2.11, 1)
    
        arc(screen, (154,154,154), [x+0.33*r+0.7*r, y+0.225*r, 0.7*r, 0.7*r], 4.1888, 5.236, 1)
    
        arc(screen, (154,154,154), [x+0.33*r+1.05*r, y+0.225*r+0.606*r, 0.7*r, 0.7*r], 1.0472, 2.11, 1)
    
        arc(screen, (154,154,154), [x+0.33*r+1.4*r, y+0.225*r, 0.7*r, 0.7*r], 4.1888, 5.236, 1)
    
        arc(screen, (154,154,154), [x+0.33*r+1.75*r, y+0.225*r+0.606*r, 0.7*r, 0.7*r], 1.0472, 2.11, 1)
...
draw_a_cat(60, 400, 400, 120, 165, 96, 23, 156, 208, 19, 1)
draw_a_cat(300, 440, 300, 90, 50, 50, 50, 255, 208, 19, 1)
draw_a_cat(300, 530, 400, 120, 50, 50, 50, 255, 208, 19, 0)
draw_a_cat(300, 230, 240, 72, 50, 50, 50, 255, 208, 19, 0)
draw_a_cat(220, 700, 300, 90, 165, 96, 23, 156, 208, 19, 1)
draw_a_cat(520, 700, 300, 90, 165, 96, 23, 156, 208, 19, 0)


ball_of_thread(400, 660, 60, 1)
ball_of_thread(200, 560, 40, 0)
ball_of_thread(300, 60, 100, 1)
ball_of_thread(100, 760, 50, 1)
